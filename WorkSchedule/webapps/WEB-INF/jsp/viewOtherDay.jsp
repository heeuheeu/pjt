  ...
  <body>
   ...
   <!--상단-->
    <section id="top-bar">
      ...
      <!--view 버튼-->
      <div class="view-btn">
        <a href="listView.html"><img src="img/list-icon-off.png"/></a>
        <a href="cardView.html"><img src="img/card-icon-on.png"/></a>
      </div>
      <!--view 버튼-->
    </section>
    <!--상단-->
...
<div class="modal fade popup" id="myModal" tabindex="-1" role="dialog"
    ...
    <script type="text/javascript">
          ...
          function prevDay(){
        	  ...
        	  $("#currDate").html(date);
        	  document.dateForm.action='calDay.inc?currDate='+$("#currDate").text();
