...
<html>
	<head>
		<meta charset="utf-8"/>
		<title>일정</title>
		<link rel="stylesheet" type="text/css" href="dncalendar-skin.css">
...
<div class="modal fade popup" id="myModal" tabindex="-1" role="dialog"
	...
	<br>
		...
		<script type="text/javascript" src="dncalendar.js"></script>
		...
		$(document).ready(function() {
    				...
    				var my_calendar = $("#dncalendar-container").dnCalendar({
    	                ...
    	                notes: [
    	                	{ "date": "2016-11-29", "note": ["일정"] },
                    		{ "date": "2016-12-02", "note": ["워크샵"] },
                    		{ "date": "2016-12-12", "note": ["출장"] },
                    		{ "date": "2016-12-25", "note": ["크리스마스"] }
                    		],
